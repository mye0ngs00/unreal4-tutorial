...
void ADoor::Open()
{
	...
	SetActorRotation(OriginRotation + FRotator(0.0f, FMath::Lerp(0.0f, 90.0f, DoorDeltaTime), 0.0f));
...
void ADoor::Close()
{
	...
	SetActorRotation(OriginRotation + FRotator(0.0f, FMath::Lerp(90.0f, 0.0f, DoorDeltaTime), 0.0f));
